...
import yaml
from .model_config import  model_registry, ModelConfig
from .api_config import api_config
from .model_utils import chat_completion_request, model_log_and_print
...
class ModelQueryManager:
    ...
    def _query_with_config(self, messages, config: ModelConfig,  system_prompt=None):
        ...
        response, total_tokens = chat_completion_request(
            messages=messages,
            model='gemini-2.5-flash-lite',# config.api_model_name,  
