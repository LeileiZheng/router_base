...
from .model_utils import model_log_and_print
...
try:
    with open("puppeteer/config/global.yaml", "r", encoding="utf-8") as f:
...
class RewardModelTokenRepresentation():
    def __init__(self):
        self.model_name ="Skywork/Skywork-Reward-V2-Llama-3.1-8B" #"nvidia/Llama-3.1-Nemotron-70B-Reward-HF"
        self.model = AutoModelForCausalLM.from_pretrained(MODEL_WEIGHT_PATH, torch_dtype=torch.bfloat16).to("cuda")
